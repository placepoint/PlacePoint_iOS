...
//        floatHeightOfSlidingContainer = slidingContainerViewController.view.frame.height
...
//        }
    ...
    func setUpNavigation() {
        ...
        self.navigationItem.navTitle(title: "Profile")
    ...
    @objc func changeTabBarIndexToFLashPost(_ notification: NSNotification) {
