...
extension AddPostVC: OpenImageProtocol {
    ...
    func removeVideoLink()  {
        ...
        headerView.txtFieldUrl.text = ""
        isVideoSend = false
        headerView.lblVideo.text = ""
        headerView.btnRemoveVideo.isHidden = true
 
        headerView.vwtextUrl.isHidden = true
    }
    
    
    func addYouTubeLink() {
        
        if isVideoSend == false {
            ...
            let alert = UIAlertController(title: "", message: "Please remove video first", preferredStyle: .alert)
