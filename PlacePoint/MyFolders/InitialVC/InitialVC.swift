        ...
        AppDataManager.sharedInstance.getAppAuth(completionHandler: { (dictResponse) in
            ...
            DispatchQueue.main.async {
                ...
                if isFirstCome == false {
                    ...
                    let vc = MultipleTownSelectionVC(nibName:"MultipleTownSelectionVC", bundle: nil)
...
extension InitialVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UserDefaults.standard.SetoneSignalSentToAPi(kDeviceIdSentToApi: false)
        
        NotificationCenter.default.post(name: Notification.Name("UpdateOneSignalIdToApi"), object: nil)
