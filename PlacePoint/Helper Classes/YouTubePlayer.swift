...
open class YouTubePlayerView: UIView, UIWebViewDelegate {
    ...
    fileprivate(set) open var playerState = YouTubePlayerState.Buffering
    ...
    fileprivate func serializedJSON(_ object: AnyObject) -> String? {
        ...
        let dictTempPlayerVar = dictTemp.value(forKey: "playerVars") as! NSDictionary
        let dictTempPlayerVar1 = dictTempPlayerVar.mutableCopy() as! NSMutableDictionary
