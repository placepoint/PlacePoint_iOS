...
class TabBarVC: UITabBarController ,UITabBarControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let tabThree = LoginVC()
        
        let navThree = UINavigationController(rootViewController: tabThree)
        
        let tabThreeBarItem3 =  UITabBarItem(title: "Business", image: #imageLiteral(resourceName: "img_business"), selectedImage: #imageLiteral(resourceName: "img_business"))
