...
//  PlacePoint
//
//  Created by Mind Root on 05/07/18.
...
class UpdatePasswordVC: UIViewController {
    ...
    func apiUpdatePassword()  {
        ...
        params["current"] = dict["currentPass"]
        
        params["new"] = dict["newPass"]
        
        params["confirm"] = dict["confirmPass"]
        
        params["email"] = UserDefaults.standard.getEmail()
