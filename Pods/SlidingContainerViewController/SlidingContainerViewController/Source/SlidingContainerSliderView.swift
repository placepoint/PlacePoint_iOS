...
//      fixedWidth: false)
    ...
    appearance = SlidingContainerSliderViewAppearance(backgroundColor: UIColor.init(red: 79/255.0, green: 93/255.0, blue: 129/255.0, alpha: 1),
//    appearance = SlidingContainerSliderViewAppearance(backgroundColor: ),
    
    
    
        font: UIFont (name: "Ubuntu-Regular", size: 14)!,
        selectedFont: UIFont (name: "Ubuntu-Regular", size: 14)!,
        textColor: UIColor.white, selectedTextColor: UIColor.white,
        outerPadding: 10,
        innerPadding: 10,
        selectorColor: UIColor(red: 77.0/255.0, green: 183.0/255.0, blue: 254.0/255.0, alpha: 1.0),
        selectorHeight: 5, fixedWidth: false)
